...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SarasasImpl sarasas2 = new SarasasImpl("Jonas","Plaktukas",5000,4.99);
        SarasasImpl sarasas3 = new SarasasImpl("Jonas","Vinis",4000,4.99);
        SarasasImpl sarasas4 = new SarasasImpl("Jonas","Vinis",5000,4.99);
        SarasasImpl sarasas5 = new SarasasImpl("Jonas","Vinis",5000,4.99);
        SarasasImpl sarasas6 = new SarasasImpl("Jonas","Vinis",5,4.99);
        SarasasImpl sarasas7 = new SarasasImpl("Jonas","Vinis",50000,4.99);
        SarasasImpl sarasas8 = new SarasasImpl("Jonas","Medsraigtis",50,4.99);
        SarasasImpl sarasas9 = new SarasasImpl("Jonas","Vinis",5000,4.99);
        SarasasImpl sarasas10 = new SarasasImpl("Jonas","Tepalas",5000,4.99);
